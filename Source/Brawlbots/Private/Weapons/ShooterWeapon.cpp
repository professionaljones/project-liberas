...
FName AShooterWeapon::GetWeaponAttachPoint() const
{
...
float AShooterWeapon::GetEquipPercentage() const
{
	const float CurrentTime = GetWorld()->GetTimeSeconds();
	return FMath::Min(1.0f, (CurrentTime - EquipStartedTime) / EquipDuration);
}
